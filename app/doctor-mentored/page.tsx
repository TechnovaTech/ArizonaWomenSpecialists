          ...
          <div className="relative z-10 container mx-auto px-4">
            ...
            <div className="text-center">
              <motion.h1 
                ...
                className="text-5xl lg:text-6xl font-light mb-8 tracking-wider text-black"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              {mentorshipFeatures.map((feature, index) => (
                ...
                >
                  <div className="h-full shadow-lg hover:shadow-xl transition-all duration-300 bg-white border-0 rounded-lg p-8 text-center">
                    <div className="w-16 h-16 bg-pink-200 rounded-full mx-auto mb-6 flex items-center justify-center">
                      <feature.icon className="w-8 h-8 text-pink-700" />
                    </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.05, y: -5 }}
                >
                  <div className="h-full shadow-xl bg-white/95 backdrop-blur-sm border-0 rounded-lg p-6">
